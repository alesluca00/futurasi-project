...
class Azioni {
    ...
    addAvatarDelete(i){
       ...
       stampaDati(persona, divAddAvatar){
         console.log('perosna::', persona);
        for( var i = 0; i < this.persone.persone.length; i++){
            if( persona == this.persone.persone[i].fiscale){
                console.log('document.getElementsByClassName(addFiscaleInput)[0].value ', divAddAvatar.getElementsByClassName('addFiscaleInput')[0].value)
                divAddAvatar.getElementsByClassName('addFiscaleInput')[0].value = this.persone.persone[i].fiscale;
                divAddAvatar.getElementsByClassName('addNomeInput')[0].value = this.persone.persone[i].nome;
                divAddAvatar.getElementsByClassName('addCognomeInput')[0].value = this.persone.persone[i].cognome;
                divAddAvatar.getElementsByClassName('addImmagineInput')[0].value = this.persone.persone[i].img;
            }
